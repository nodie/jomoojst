...
public class JomooJst {
	...
	static final String LOGFILE_STRING = "logs/jstlogs.txt";
	
    static final String FILENAME_STRING = "xileiqi.2018.03.05.txt";
	...
	public static void main(String[] args) throws Throwable {
		...
		for (Integer key : apiMap.keySet()) {
			...
			System.out.println("UID_INTEGER="+ uid + " NICK="+ nickString + " APPKEY_STRING="+ appkeyString + " SECRET_STRING=" + secretString);
			
			ClientThread clientThread = new ClientThread(apiMap.get(key).tpid, uid, appkeyString, secretString, nickString);
			clientThread.start();
